  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            description: '',
            cover: 'https://wallpaperaccess.com/full/233354.jpg',
      ...
      },
      {
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04', title: 'Title of card 11', description: null, cover: null, memberIds: [], comments: [], attachments: [], FE_PlaceholderCard: true },
        ],
