...
function CardDescriptionMdEditor({
  ...
  // Lay gia tri 'dark', 'light' hoac 'system' mode tu MUI de support Markdown (data-color-mode={mode})
  // https://www.npmjs.com/package/@uiw/react-md-editor#support-dark-modenight-mode
  const { mode } = useColorScheme();

  // State xu ly che do Edit va che do View
  const [markdownEditMode, setMarkdownEditMode] = useState(false);
  // State xu ly gia tri markdown khi edit
        ...
        <Box sx={{ mt: 5, display: "flex", flexDirection: "column", gap: 1 }}>
          <Box data-color-mode={mode}>
            <MDEditor
              ...
              height={300}
              preview="edit"
              //['edit', 'live', 'preview'] tuy nhu cau ma set
              // hideToolbar={true}
            />
          </Box>
          <Button
